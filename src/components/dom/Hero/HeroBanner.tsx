...
export default function HeroBanner() {
  return (
    <div className='h-screen bg-neutral-900/5 dark:bg-neutral-400/5' data-target='hero'>
      <div className='flex flex-col items-center justify-center w-full h-full'>
        <div className='w-full px-4 py-8 text-center bg-repeat bg-noise bg-[length:150px] bg-[0px_0px] backdrop-blur-xl'>
