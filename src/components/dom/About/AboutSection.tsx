...
flex w-[90%] grow flex-row items-center justify-center gap-8 rounded-3xl  backdrop-blur-sm
bg-noise shadow-2xl bg-slate-50/75 dark:bg-slate-800/60 dark:text-white xl:max-w-7xl xl:flex-row overflow-x-hidden overflow-y-auto
`
